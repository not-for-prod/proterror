...
type MessageOptions struct {
	...
	// internal marks the error as private and replaces it with UNKNOWN in client responses.
...
func (x *MessageOptions) GetInternal() bool {
	if x != nil {
		return x.Internal
	}
	return false
...
const file_proterror_options_proto_rawDesc = "" +
	"\n" +
	"\x17proterror/options.proto\x12\tproterror\x1a google/protobuf/descriptor.proto\x1a\x15google/rpc/code.proto\"R\n" +
	"\x0eMessageOptions\x12$\n" +
	"\x04code\x18\x01 \x01(\x0e2\x10.google.rpc.CodeR\x04code\x12\x1a\n" +
	"\binternal\x18\x02 \x01(\bR\binternal:U\n" +
